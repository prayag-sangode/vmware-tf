  ...
  clone {
    ...
    customize {
      linux_options {
        ...
        domain    = "k8s-master.example.com"
      }

      network_interface {
        ipv4_address    = "192.168.200.47"
        ipv4_netmask    = 24
...
resource "vsphere_virtual_machine" "vm2" {
  ...
  clone {
    ...
    customize {
      linux_options {
        host_name = "k8s-worker"
        domain    = "k8s-worker.example.com"
      }
